augroup filetypedetect
    ...
    autocmd BufNewFile,BufRead *.{cfg,cnf,coveragerc,sentryclirc,service,tigrc,timer},cqlshrc,{krb5,pip,spark-defaults,supervisord}.conf,.{scalafmt,scalafix}.conf,.bandit setlocal filetype=dosini
