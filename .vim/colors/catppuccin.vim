...
if &background == 'dark'
  ...
  hi PmenuBorder guifg=#b4befe guibg=#181825 guisp=NONE gui=NONE ctermfg=147 ctermbg=232 cterm=NONE
  ...
  hi PmenuKind guifg=#89b4fa guibg=#181825 guisp=NONE gui=NONE ctermfg=111 ctermbg=232 cterm=NONE
  hi PmenuKindSel guifg=#89b4fa guibg=#313244 guisp=NONE gui=bold ctermfg=111 ctermbg=236 cterm=bold
  hi PmenuMatch guifg=#cdd6f4 guibg=NONE guisp=NONE gui=bold ctermfg=189 ctermbg=NONE cterm=bold
  hi PmenuMatchSel guifg=#cdd6f4 guibg=NONE guisp=NONE gui=bold ctermfg=189 ctermbg=NONE cterm=bold
  ...
  hi Popup guifg=#cdd6f4 guibg=#181825 guisp=NONE gui=NONE ctermfg=189 ctermbg=232 cterm=NONE
  hi PopupTitle guifg=#a6adc8 guibg=#181825 guisp=NONE gui=NONE ctermfg=146 ctermbg=232 cterm=NONE
  ...
  hi SignifySignAdd guifg=#a6e3a1 guibg=NONE guisp=NONE gui=NONE ctermfg=114 ctermbg=NONE cterm=NONE
  hi SignifySignChange guifg=#f9e2af guibg=NONE guisp=NONE gui=NONE ctermfg=222 ctermbg=NONE cterm=NONE
  hi SignifySignDelete guifg=#f38ba8 guibg=NONE guisp=NONE gui=NONE ctermfg=211 ctermbg=NONE cterm=NONE
  ...
  hi VertSplit guifg=#b4befe guibg=NONE guisp=NONE gui=NONE ctermfg=147 ctermbg=NONE cterm=NONE
  hi VertSplitNC guifg=#11111b guibg=NONE guisp=NONE gui=NONE ctermfg=16 ctermbg=NONE cterm=NONE
  ...
  if s:t_Co >= 16
    ...
    hi PmenuBorder ctermfg=LightGrey ctermbg=DarkGrey cterm=NONE
    hi PmenuExtra ctermfg=Grey ctermbg=DarkGrey cterm=NONE
    hi PmenuExtraSel ctermfg=Grey ctermbg=DarkYellow cterm=bold
    hi PmenuKind ctermfg=Blue ctermbg=DarkGrey cterm=NONE
    hi PmenuKindSel ctermfg=Blue ctermbg=DarkYellow cterm=bold
...
if &background == 'light'
  ...
  hi PmenuBorder guifg=#7287fd guibg=#e6e9ef guisp=NONE gui=NONE ctermfg=69 ctermbg=255 cterm=NONE
  ...
  hi PmenuKind guifg=#1e66f5 guibg=#e6e9ef guisp=NONE gui=NONE ctermfg=27 ctermbg=255 cterm=NONE
  hi PmenuKindSel guifg=#1e66f5 guibg=#ccd0da guisp=NONE gui=bold ctermfg=27 ctermbg=253 cterm=bold
  ...
  hi Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
  hi VertSplit guifg=#7287fd guibg=NONE guisp=NONE gui=NONE ctermfg=69 ctermbg=NONE cterm=NONE
  ...
  if s:t_Co >= 16
    ...
    hi PmenuBorder ctermfg=DarkBlue ctermbg=Grey cterm=NONE
    hi PmenuExtra ctermfg=DarkGrey ctermbg=Grey cterm=NONE
    hi PmenuExtraSel ctermfg=DarkGrey ctermbg=Grey cterm=bold
    hi PmenuKind ctermfg=Blue ctermbg=Grey cterm=NONE
    hi PmenuKindSel ctermfg=Blue ctermbg=Grey cterm=bold
