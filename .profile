...
if [ "$UID" -eq "0" ]; then
    umask 022
    PS1='[1;31m\u[0;0m@[1;35m\H[0;0m [1;32m\w[0;0m \D{%F %T} [1;$((\j == 0 ? 30 : 36))m\j[0;0m [1;$(($? == 0 ? 30 : 31))m$?[0;0m [7;31m${AWS_PROFILE:-}[0;0m\n\$ '
else
    umask 027
    PS1='[1;34m\u[0;0m@[1;35m\H[0;0m [1;32m\w[0;0m \D{%F %T} [1;$((\j == 0 ? 30 : 36))m\j[0;0m [1;$(($? == 0 ? 30 : 31))m$?[0;0m [7;31m${AWS_PROFILE:-}[0;0m\n\$ '
fi
export PS1="\n$PS1"
